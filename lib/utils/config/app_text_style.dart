...
import 'package:easy_english/utils/gen/fonts.gen.dart';
...
class AppTextStyle {
  ...
  static TextStyle w500s14(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w500, 14, color, height: height, letterSpacing: letterSpacing);
  }
  ...
  static TextStyle w500s16(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w500, 16, color, height: height, letterSpacing: letterSpacing);
  }
  ...
  static TextStyle w600s14(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w600, 14, color, height: height, letterSpacing: letterSpacing);
  }
  ...
  static TextStyle w600s30(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w600, 30, color, height: height, letterSpacing: letterSpacing);
  }
  ...
  static TextStyle w700s10(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w700, 10, color, height: height, letterSpacing: letterSpacing);
  }

  static TextStyle w700s11(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w700, 11, color, height: height, letterSpacing: letterSpacing);
  }
  ...
  static TextStyle w600s35(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w600, 35, color, height: height, letterSpacing: letterSpacing);
  }

  static TextStyle w800s35(Color color, {double? height, double? letterSpacing}) {
    return _styleWith(FontWeight.w800, 35, color, height: height, letterSpacing: letterSpacing);
  }
}
