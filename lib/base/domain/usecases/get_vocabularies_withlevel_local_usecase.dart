...
class GetVocabulariesWithCourseLocalUsecase extends UseCaseIO<int, List<VocabularyLocal>> {
  GetVocabulariesWithCourseLocalUsecase(this.vocabularyLocalRepo);
  final VocabularyLocalRepo vocabularyLocalRepo;

  @override
  Future<List<VocabularyLocal>> build(int input) {
    return vocabularyLocalRepo.getVocabulariesWithCourseId(input);
  }
}
