...
class GameController extends BaseController {
  ...
  void loadSearchWord() {
    _storageService.getMyWord(AppConfig.accountInfo.id ?? 0).then((value) async {
  ...
  void addVocabulary() {
    ...
    _storageService.setMyWord(words, AppConfig.accountInfo.id ?? 0).then((value) {
      Get.back();
      loadSearchWord();
    });
  }
  ...
  void removeWord() {
    _storageService.removeMyWord(AppConfig.accountInfo.id ?? 0).then((value) => loadSearchWord());
  }
}
